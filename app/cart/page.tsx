  ...
  return (
    <div className="mx-auto min-h-screen max-w-2xl bg-slate-50 pb-28">
      ...
      <div className="space-y-4 p-4">
        ...
        {/* Delivery Address Card matching Stitch */}
        <section className="rounded-2xl border border-slate-200/90 bg-white p-4 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            <h2 className="flex items-center gap-2 text-sm font-bold text-slate-900">
              <MapPin size={18} className="text-orange-600 fill-orange-600/20" /> Delivery Address
            </h2>
            <Link href="/account/addresses" className="text-2xs font-extrabold uppercase text-orange-600 hover:underline">
              Change
            </Link>
          </div>
          <div className="ml-6 space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-slate-900">Bandra West, Mumbai</span>
            </div>
            <p className="text-xs text-slate-500 line-clamp-2 font-medium">
              Apt 402, Sea View Residency, Carter Road, Bandra West, Mumbai 400050
            </p>
